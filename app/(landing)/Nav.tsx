...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white backdrop-blur-md shadow-md z-50 transition-all">
      <div className="flex items-center justify-between px-6 py-4">
        {/* LOGO animé */}
        <div className="flex items-center space-x-1 text-neutral-900 text-3xl font-bold text-primary">
          <span>M</span>
          <span>b</span>
          <motion.span
            animate={{ rotate: 360 }}
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              exit={{ y: "-100%" }}
              transition={{ duration: 0.3 }}
              className="fixed top-0 left-0 w-full h-screen bg-white shadow-md rounded-b-2xl p-6 space-y-4 z-50"
